...
df = pd.read_csv('/projects/sebr8260/OutputRaw/FOXNEWS/FOXNEWS_2020_output.csv')
...
df.to_csv('/projects/sebr8260/OutputRaw/FOXNEWS/FOXNEWS_2020_output.csv', index=False)
