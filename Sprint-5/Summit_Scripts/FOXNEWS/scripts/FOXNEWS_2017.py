...
df = pd.read_csv('/projects/sebr8260/OutputRaw/FOXNEWS/FOXNEWS_2017_output.csv')
...
df.to_csv('/projects/sebr8260/OutputRaw/FOXNEWS/FOXNEWS_2017_output.csv', index=False)
