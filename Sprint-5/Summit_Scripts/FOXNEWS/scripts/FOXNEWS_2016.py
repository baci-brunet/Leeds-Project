...
df = pd.read_csv('/projects/sebr8260/OutputRaw/FOXNEWS/FOXNEWS_2016_output.csv')
...
df.to_csv('/projects/sebr8260/OutputRaw/FOXNEWS/FOXNEWS_2016_output.csv', index=False)
