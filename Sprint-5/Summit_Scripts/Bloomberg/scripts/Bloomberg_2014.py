...
df = pd.read_csv('/projects/sebr8260/OutputRaw/Bloomberg/Bloomberg_2014_output.csv')
...
df.to_csv('/projects/sebr8260/OutputRaw/Bloomberg/Bloomberg_2014_output.csv', index=False)
