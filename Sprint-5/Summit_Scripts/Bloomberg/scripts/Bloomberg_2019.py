...
df = pd.read_csv('/projects/sebr8260/OutputRaw/Bloomberg/Bloomberg_2019_output.csv')
...
df.to_csv('/projects/sebr8260/OutputRaw/Bloomberg/Bloomberg_2019_output.csv', index=False)
