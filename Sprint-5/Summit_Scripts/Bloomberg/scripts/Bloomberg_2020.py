...
df = pd.read_csv('/projects/sebr8260/OutputRaw/Bloomberg/Bloomberg_2020_output.csv')
...
df.to_csv('/projects/sebr8260/OutputRaw/Bloomberg/Bloomberg_2020_output.csv', index=False)
